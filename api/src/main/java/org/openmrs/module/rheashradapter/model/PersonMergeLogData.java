...
public class PersonMergeLogData {
	...
	private Map<String, String> movedObservations;
	...
	public Map<String, String> getMovedObservations() {
		return movedObservations;
	}
	
	public void addMovedObservations(String uuid, String uuid2) {
		if (movedObservations == null) {
			movedObservations = new HashMap<String, String>();
		}
		
		if(movedObservations.containsKey(uuid)){
			String value = movedObservations.get(uuid);
			value += "|"+ uuid2;
			movedObservations.put(uuid, value);
		}else{
		movedObservations.put(uuid, uuid2);
		}
	}
	...
	public int computeHashValue() {
		...
		if (getMovedObservations() != null)
			str += getMovedObservations().toString();
