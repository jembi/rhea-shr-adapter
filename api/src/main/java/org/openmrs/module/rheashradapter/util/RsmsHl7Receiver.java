 ...
 * @version 1.0
 */
public class RsmsHl7Receiver {
	
	Log log = LogFactory.getLog(RsmsHl7Receiver.class);
	
	private GenericParser parser;
	
	private MessageTypeRouter router;
	
	public RsmsHl7Receiver() {
	...
	public Message processMessage(String hl7, String enterpriseId) throws HL7Exception {
		...
		router.registerApplication("ORU", "R01", new RsmsNotificationHandler(enterpriseId));
