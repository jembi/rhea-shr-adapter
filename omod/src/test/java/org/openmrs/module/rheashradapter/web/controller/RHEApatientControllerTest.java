...
public class RHEApatientControllerTest extends BaseModuleContextSensitiveTest {
	...
	public void getEncounters_shouldGetMatchingEncountersByPatientECIDFromDatabase()
			throws Exception {

		Context.getAdministrationService().addGlobalProperty(
				"rheashradapter.sendingFaculty", "Shared Health Record");
	...
	public void getEncounters_shouldGetMatchingEncountersByEncounterUniqueId()
			throws Exception {
		...
		try {
			object = controller.getEncounters(enterpriseId, idType,
					encounterUniqueId, null, null, null, request, response);
		} catch (Exception e) {
			Assert.fail("Controller should not throw an exception");
		}
	...
	public void getEncounters_shouldGetMatchingEncountersByDateCreated()
			throws Exception {
		...
		try {
			object = controller.getEncounters(enterpriseId, idType, null,
					"2005-04-31T12:30:23", null, null, request, response);
		} catch (Exception e) {
			Assert.fail("Controller should not throw an exception");
		}
...
ORU_R01 orur01 = (ORU_R01) message;
	...
	public void getEncounters_shouldGetMatchingEncountersByDateEnd()
			throws Exception {
		...
		try {
			object = controller.getEncounters(enterpriseId, idType, null, null,
					"2007-05-02T12:30:23", null, request, response);
		} catch (Exception e) {
			Assert.fail("Controller should not throw an exception");
		}
	...
	public void createEncounters_shouldParseHL7MessageIntoPOJOs()
			throws Exception {
		RHEApatientController controller = new RHEApatientController();
		...
		assertEquals(Context.getEncounterService().getEncountersByPatientId(2)
				.size(), 1);

		String hl7 = IOUtils.toString(getClass().getClassLoader()
				.getResourceAsStream("sample-orur01.xml"));

		Encounter encounter = null;

		try {
			encounter = (Encounter) controller.createEncounters(hl7,
					enterpriseId, idType, null, request, response);
		} catch (Exception e) {
			Assert.fail("Controller should not throw an exception");
		}
	...
	public void createEncounters_shouldfailOnUnknownNotificationType()
			throws Exception {
		RHEApatientController controller = new RHEApatientController();
		...
		try {
			controller.createEncounters(hl7, enterpriseId, idType, "UNKNOWN",
					request, response);
		} catch (Exception e) {
			Assert.fail("Controller should not throw an exception");
		}
	...
	public void createEncounters_shouldCreateORUR01MessageForKnownNotificationType()
			throws Exception {
		RHEApatientController controller = new RHEApatientController();
		...
		try {
			encounter = (Encounter) controller.createEncounters(hl7,
					enterpriseId, idType, "RISK", request, response);
		} catch (Exception e) {
			Assert.fail("Controller should not throw an exception");
		}
	...
	public void mergePatients_shouldParseMergeMessageAccurately()
			throws Exception {
		RHEApatientController controller = new RHEApatientController();
		...
		String mergeMessage = IOUtils.toString(getClass().getClassLoader()
				.getResourceAsStream("sample-merge-message.xml"));
		...
		assertEquals(((MockHttpServletResponse) response).getStatus(),
	...
	public void mergePatients_shouldFailWithInvalidPatientIdentifier()
			throws Exception {
		RHEApatientController controller = new RHEApatientController();
		...
		String mergeMessage = IOUtils.toString(getClass().getClassLoader()
				.getResourceAsStream("merge-message-with-error.xml"));
